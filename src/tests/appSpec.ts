...
describe('Image endpoint tests', () => {
    ...
    it(`should return ${StatusCodes.BAD_REQUEST} for not providing an image name`, async () => {
    ...
    it(`should return ${StatusCodes.BAD_REQUEST} for a non-existent filename`, async () => {
        const res = await request
            .get('/api/v1/images')
